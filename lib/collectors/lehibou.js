  ...
  try {
    ...
    if (error?.status === 403 || error?.status === 429) {
      return {
        ...
        fetchedAt: new Date().toISOString(),
        robots,
        automatedAccess: "blocked_by_technical_protection",
        metrics: null,
        evidenceKind: "access_status",
        note:
          "Automated page collection is not used because the public page returned a technical access-control response. No bypass is attempted."
      };
    }
    throw error;
  }
