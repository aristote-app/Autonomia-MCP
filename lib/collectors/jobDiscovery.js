...
const DEFAULT_JOB_DISCOVERY_QUERIES = Object.freeze([
  {
    sourceId: "linkedin",
    query:
      'site:fr.linkedin.com/jobs/view ("freelance" OR "indépendant" OR "mission freelance") ("AI Engineer" OR "IA" OR "GenAI" OR "LLM" OR "RAG" OR "Agentic AI" OR "Copilot") France'
  },
  {
    sourceId: "linkedin",
    query:
      'site:fr.linkedin.com/jobs/view ("Freelance" OR "indépendant") ("consultant IA" OR "AI Engineer" OR "Generative AI" OR "Agentic AI" OR "MLOps")'
  },
  {
    sourceId: "indeed",
    query:
      'site:fr.indeed.com/viewjob ("Indépendant / freelance" OR "freelance") ("AI Engineer" OR "IA" OR "GenAI" OR "LLM" OR "RAG" OR "Agentic AI" OR "Copilot") France'
  },
  {
    sourceId: "indeed",
    query:
      'site:fr.indeed.com/viewjob ("IT) / Freelance" OR "Indépendant / freelance") ("IA générative" OR "AI Engineer" OR "Agentic AI" OR "MLOps")'
  }
]);
...
export function normalizeJobSearchResult({ sourceId, query, result }) {
  ...
  const freelance = /freelance|ind[eé]pendant/i.test(text);
  ...
  for (const spec of queries) {
    ...
    try {
      ...
      const normalized = results
        ...
        .filter((item) => item.contractType === "Freelance / indépendant")
        .filter((item) => {
          const evidence = [
            item.title,
          ...
          return !/candidatures? ne sont plus accept[ée]es|offre expir[ée]e|poste pourvu|job is no longer available/i.test(evidence);
        });
