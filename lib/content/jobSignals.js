const TAXONOMY = Object.freeze({
  ...
  skills: [
    ...
    ["workflow_orchestration", "Orchestration de workflows", /\bworkflows?\b|\borchestrat(?:ion|eur|or)\b/i],
    ["automation", "Automatisation", /\bautomation\b|\bautomatis(?:ation|er|[ée]e?s?|[ée]s?)\b|\brpa\b/i],
...
const KEYWORD_SEEDS = Object.freeze({
  n8n: ["automatisation n8n entreprise", "formation n8n entreprise", "n8n ia entreprise"],
  power_platform: ["Power Automate IA entreprise", "formation Power Automate IA", "Copilot Power Automate"],
  copilot: ["formation Microsoft Copilot entreprise", "Copilot Studio agents IA", "automatiser Microsoft 365 avec IA"],
  rag: ["RAG entreprise", "assistant documentaire RAG", "formation RAG entreprise"],
  agents: ["agents IA entreprise", "automatisation agentique", "formation agents IA"],
  governance: ["gouvernance IA entreprise", "formation gouvernance IA", "AI Act entreprise"],
  ai_governance: ["consultant gouvernance IA", "AI Governance entreprise"],
  observability: ["observabilité LLM", "supervision agents IA", "monitoring IA générative"],
  guardrails: ["sécurité LLM entreprise", "guardrails IA générative", "prompt injection entreprise"],
  knowledge_management: ["assistant IA base de connaissances", "IA documentation interne", "RAG base documentaire"],
  document_processing: ["automatiser documents avec IA", "extraction document IA entreprise", "workflow documentaire IA"],
  customer_support: ["automatiser support client avec IA", "agent IA service client", "formation IA support client"],
  sales_automation: ["automatisation commerciale IA", "IA CRM entreprise", "RevOps IA automation"],
  messaging_collaboration: ["automatiser emails avec IA", "assistant IA messagerie entreprise", "automatisation Gmail IA"],
  files_documents: ["automatiser Google Drive avec IA", "IA gestion documentaire entreprise", "classer documents automatiquement IA"],
  process_integration: ["automatiser processus métier avec IA", "workflow IA entreprise", "intégration IA processus métier"],
  ai_project_manager: ["AI Project Manager freelance", "consultant chef de projet IA"],
  agentic_ai_engineer: ["Agentic AI Engineer freelance", "expert agents IA entreprise"],
  ai_automation_engineer: ["AI Automation Engineer", "expert automatisation IA entreprise"]
});
...
function keywordSeeds(keys = []) {
  return [...new Set(
    keys.flatMap((key) => KEYWORD_SEEDS[key] || [])
  )];
}
...
export function extractJobContentSignals(job = {}) {
  ...
  return {
    ...
    useCases,
    signalKeys,
    keywordSeeds: keywordSeeds(signalKeys),
